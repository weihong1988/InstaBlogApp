...
import { ActivityIndicator, Image, StyleSheet, Text, View, TextInput, TouchableOpacity, Keyboard, ScrollView } from "react-native";
      ...
      (
        ...
        <ScrollView>
          <View style={{flexDirection: "row", alignItems: "center", marginBottom: 16,}}>
            <Image source={{ uri: IMAGE_URL + profilePic }} style={{ width: 100, height: 100 }} borderRadius={50} />
